...
import lundogbendsen.model.Course;
import lundogbendsen.model.CourseType;
import lundogbendsen.model.CourseDto;
import lundogbendsen.model.InstructorRole;
import lundogbendsen.model.Period;
import lundogbendsen.model.Person;
import lundogbendsen.model.Role;
import lundogbendsen.model.StudentRole;
...
public class StandaloneJpaClient {
	...
	public static void exerciseWithJPA(JpaUtil.HibernateLoggingConfig loggingConfig, 
		...
		}
		{
			...
			String jpaql = "";
			jpaql += "SELECT NEW lundogbendsen.model.CourseDto(c.courseType.number, c.period, c.instructor.personAssignedToRole.name)";
			jpaql += "\n ";
			jpaql += "FROM Course c" + "\n ";
