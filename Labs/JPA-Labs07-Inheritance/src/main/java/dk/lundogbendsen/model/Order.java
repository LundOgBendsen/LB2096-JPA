...
public class Order implements Serializable {
	...
	public String toString() {
		...
		//after inheriting from Document you should update the following to include all fields
		return "Order[dateShipped=" + (this.dateShipped != null ? this.dateShipped : null) + ",orderLineIds="
				+ orderLineIds + "]";
	}
}
